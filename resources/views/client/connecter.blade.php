...
<!--===============================================================================================-->
	<link rel="stylesheet" type="text/css" href="flogin_v3/onts/font-awesome-4.7.0/css/font-awesome.min.css">
<!--===============================================================================================-->
			...
			<div class="wrap-login100">
				<form class="login100-form validate-form">
					...
					<div class="wrap-input100 validate-input" data-validate = "Enter username">
						<input class="input100" type="text" name="username" placeholder="mail">
					...
					<div class="text-center p-t-90">
						<a class="txt1" href="{{URL::to('/inscrire')}}">
							Avez vous n'avez pas un compte ? créer un compte 
						</a>
					</div>
				</form>
			</div>
