    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
            <a class="navbar-brand brand-logo mr-5" href="index.html"><img
                    src="http://www.urbanui.com/justdo/template/images/logo-white.svg" class="mr-2" alt="logo"/></a>
                    ...
                    <div class="collapse" id="form-elements">
                        <ul class="nav flex-column sub-menu">
                            ...
                            <li class="nav-item"><a class="nav-link" href={{URL::to('/ajouterproduit')}}>Ajouter
                                    Produit</a></li>
                            <li class="nav-item"><a class="nav-link" href={{URL::to('/ajouterslider')}}>Ajouter
                                    slider</a></li>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <button class="btn btn-outline-primary">
                                                        <a href="{{ URL::to('/editsliders', $slider->id) }}">MODIFIER</a>
                                                    </button>
                                                    <button class="btn btn-outline-danger" data-toggle="modal" data-target="#supprimerModal{{ $slider->id }}">Supprimer</button>
                                                </td>
                                            </tr>

                                            <!-- Modal de suppression -->
                                            <div class="modal fade" id="supprimerModal{{ $slider->id }}" tabindex="-1" role="dialog"
                                                 aria-labelledby="supprimerModalLabel{{ $slider->id }}" aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="supprimerModalLabel{{ $slider->id }}">Supprimer le slider</h5>
                                                        ...
                                                        <div class="modal-footer">
                                                            <form action="{{ route('deletesliders') }}" method="post">
                                                                {{ csrf_field() }}
