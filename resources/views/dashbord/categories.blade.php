...
<div class="container-fluid page-body-wrapper">
                ...
                <div class="collapse" id="form-elements">
                    <ul class="nav flex-column sub-menu">
                        <li class="nav-item"><a class="nav-link" href={{URL::to('/ajoutercategorie')}}>Ajouter
                                Catégorie</a></li>
                        <li class="nav-item"><a class="nav-link" href={{URL::to('/ajouterproduit')}}>Ajouter Produit</a>
                        </li>
    ...
    <div class="main-panel">
        <div class="content-wrapper">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button class="btn btn-outline-primary" data-toggle="modal"
                                                        data-target="#modifierModal{{$category->id}}">Modifier
                                                </button>
                                                <button class="btn btn-outline-danger" data-toggle="modal"
                                                        data-target="#supprimerModal{{$category->id}}">Supprimer
                                                </button>
                                            </td>
                                        </tr>
                                    @endforeach
            ...
            @foreach ($categories as $category)
                <div class="modal fade" id="modifierModal{{ $category->id }}" tabindex="-1" role="dialog"
                     aria-labelledby="modifierModalLabel{{ $category->id }}" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="modifierModalLabel{{ $category->id }}">Modifier la
                                    catégorie</h5>
                                ...
                                <form action="{{route('editcategorie')}}" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="category_name"
                                               placeholder="Nom de la catégorie" value="{{ $category->nom_categorie }}">
                                    </div>
            ...
            <!-- Modal Supprimer -->
            @foreach ($categories as $category)
                <div class="modal fade" id="supprimerModal{{ $category->id }}" tabindex="-1" role="dialog"
                     aria-labelledby="supprimerModalLabel{{ $category->id }}" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="supprimerModalLabel{{$category->id}}">Supprimer la
                                    catégorie</h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
