...
<html lang="en">
  ...
  <body class="goto-here">
	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
			  <li class="nav-item active"><a href="{{URL::to('/home')}}" class="nav-link">Acceuil</a></li>
			  <li class="nav-item active"><a href="{{URL::to('/shop')}}" class="nav-link">Produit</a></li>
			  <li class="nav-item active"><a href="shop.html" class="nav-link">A propos</a></li>
    ...
    <section id="home-section" class="hero">
        ...
        <div class="slider-item" style="background-image: url(frontend/images/bg_40.jpg);">
            <div class="overlay"></div>
          <div class="container">
            <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">

              <div class="col-md-12 ftco-animate text-center">
                <h1 class="mb-2">vous êtes les biens arrivés à voisinagefood</h1>
          ...
          <div class="container">
            <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
              ...
              <div class="col-sm-12 ftco-animate text-center">
                <h1 class="mb-2">Nous avons les meilleurs plats</h1>
                <p><a href="#" class="btn btn-primary">Voir les details</a></p>
              </div>
